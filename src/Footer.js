...
function Footer() {
    ...
    return (
        ...
        <div className="footer p-4 p-sm-5 ">
            <div className="contaner text-center  text-white ">
                ...
                <div className="contact mt-4">
                    ...
                    <div className=" d-flex align-items-center justify-content-center gap-3">
                        ...
                        <a href={linkedinUrl} target="_blank" rel="noopener noreferrer" className="linkedin fs-4" >
